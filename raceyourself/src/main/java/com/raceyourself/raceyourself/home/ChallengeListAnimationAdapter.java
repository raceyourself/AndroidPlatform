...
/**
 * Created by Amerigo on 14/07/2014.
 */
@Slf4j
public class ChallengeListAnimationAdapter extends ExpandableListItemAdapter<ChallengeNotificationBean>{
    Activity context;
    List<ChallengeNotificationBean> challengeNotifications;

    public ChallengeListAnimationAdapter(Activity context, List<ChallengeNotificationBean> challenges) {
    ...
    @Override
    public View getTitleView(int groupPosition, View convertView, ViewGroup parent) {
