...
class ChallengeVersusAnimator implements ExpandCollapseListener {
    ...
    private final Runnable runnable = new Runnable() {
        ...
        public void run() {
            ...
            final RelativeLayout rl = (RelativeLayout) activity.findViewById(R.id.activity_home);
            ...
            clone.animate().x(location[0] - parent_location[0]).y(location[1] - parent_location[1]).setDuration(1500).setListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    opponentRank.setImageDrawable(activity.getResources().getDrawable(R.drawable.icon_badge_small));
    ...
    public ChallengeVersusAnimator(Activity activity, ChallengeListAdapter adapter) {
        this(activity, adapter, null);
    }

    public ChallengeVersusAnimator(Activity activity, ChallengeListAdapter adapter, ExpandCollapseListener chained) {
    ...
    public void onItemExpanded(int position) {
        ...
        final ImageView opponentRank = (ImageView)rl.findViewById(R.id.opponentRank);
        opponent.setImageDrawable(activity.getResources().getDrawable(R.drawable.default_profile_pic));
